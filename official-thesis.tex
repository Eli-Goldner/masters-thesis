...
As potentially sensitive software systems are increasingly support natural language input
and rely on natural language data (NLP and dialogue systems for health and mission critical tasks),
finding ways to integrate explainability and certainty for working with
natural language will become increasingly relevant.
