...
as is usually the case with tableaux methods.  Using tableaux as a decision
procedure for satisfiability requires some further notions
...
\begin{definition}[{\bf Saturated branch}]
