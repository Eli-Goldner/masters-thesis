...
as is usually the case with tableaux methods.  Using tableaux as
a means of model checking has precedent in \citet*{bhat1998tableau} Using tableaux as a decision
