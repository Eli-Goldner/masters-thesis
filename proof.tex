...
In the universal rules \cref{univ} $s : p$ is any parameter at $s$.  
...
\begin{proof}
  ...
  in the proof from \citet*{bolander2009terminating} it holds here as well.
