...
\begin{document}
	...
	\end{frame}
        ...
        \begin{frame}{AMR with Scope and Quantification}
          \begin{itemize}
          \item Handles quantification and negation.
          \item Anotates the scope of the arguments of the central predicate.
        ...
        \begin{frame}{Tableaux for Model Checking}
          ...
          \item
            This is bad for reasoning in real time.
          \item
        ...
        \begin{frame}{Model Checking Example}
          ...
          $$D_{\textit{now}} = \{\textit{computer}_1, \textit{computer}_2, \textit{desk}_1, \textit{desk}_2 \}$$
          $$D_{\textit{tomorrow}} = \{\textit{computer}_1, \textit{computer}_2, \textit{computer}_3, \textit{desk}_1, \textit{desk}_2\}$$
        ...
        \begin{frame}{Extraction}
          ...
          \item
            \texttt{<reference>} (if present) gives us the tense, e.g. $@_t P \psi$
          \item
