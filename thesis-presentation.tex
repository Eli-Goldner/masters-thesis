	...
	\end{frame}
        ...
        \begin{frame}{Hybrid Logic Variants}
          ...
          \item
            ...
            {\it There is someone (out of {\bf all} people) who can afford some car (out of all cars).}
          \item
            Option 2: Each world has a different domain:
            {\it There is someone (out of everyone around {\bf now}) who can afford some car (out of all cars around now).}
          \end{itemize}
          First option is called possibilist quantification, second is callled actualist.
          We will use actualist quantification.
        \end{frame}
        
        \begin{frame}{First-Order Hybrid Tense Logic}
          \begin{itemize}
          \item Quantified hybrid logic, but with tense modalities $F$ and $P$ instead of $\lozenge$.
          \item 
          \end{itemize}
        \end{frame}
