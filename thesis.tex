...
\begin{proof}
  ...
  For {\bf ($\exists$)}, recalling \ref{finite-vars} again, 
  we check each variable assignment from a finite set whether they have
  a variant at a fixed variable that satisfies  
  and for {\bf ($\neg \exists$)} 
\end{proof}
