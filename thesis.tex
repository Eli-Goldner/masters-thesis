...
\enumsentence{
  ...
  \small\texttt{(s / scope\\
    ...
    \hspace*{1.0cm}:ARG1 c)}
  \\
  c. $\forall y [ \text{desk}(y) \to \exists[\text{computer}(x) \land F \text{be-located-at-91}(x, y)]]$
  \\
  d. Also acceptable $F \forall y [ \text{desk}(y) \to \exists[\text{computer}(x) \land  \text{be-located-at-91}(x, y)]]$
}
