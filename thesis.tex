...
\citet{pustejovsky-etal-2019-modeling}
...
The differences manifest with regards to the model and
...
in addition to tense.  For instance, again using the  
...
affords reasoning for AMR sentences,
