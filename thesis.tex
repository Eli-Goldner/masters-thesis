...
A formula is satisfiable if there is some model where the formula true,
...
When working with the tableau calculus, following \citet*{hansen2007tableau} we 
introduce a countably infinite list of parameters \textsf{PAR}, where parameters are
constants which are used exlusively to instantiate quantifiers and are never quantified over.
...
and {\bf ($P / F$)--trans}, the soundness of which are straighfoward to demonstrate
