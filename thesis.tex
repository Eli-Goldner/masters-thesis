...
\subsection{Situation Semantics Influenced -- TTR -- Robin Cooper / Jonathan Ginzburg / Massimio Poesio}


\subsection{Episodic Logic}

Episodic Logic is a Montague-style logical form based SR/KR
with relative strength in semantic expressivity and inferetiability
in comparison to other SR/KRs, making it better comparatively better suited
for deep NLU \cite{schubert2015}.  Episodic Logic allows for generalized quantifiers, lambda abstraction,
