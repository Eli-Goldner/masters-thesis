...
\begin{proof}
  ...
  Since $\Theta$ is infinite the graph has some inifinite branch
...
if the root formula is a sentence however then to be satisfied we
require it is annotated with every variable assignment.
