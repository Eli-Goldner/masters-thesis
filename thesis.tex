...
\begin{proof}
  ...
  Furthermore the model has only finitely many worlds/times and a
  ...
  closed terms terminates.  Since the @ rules, modal rules, and equality rules, and
  {\bf ($\neg \neg$)}
  ...
  a variant at a single variable 
  and for {\bf ($\neg \exists$)} 
\end{proof}
