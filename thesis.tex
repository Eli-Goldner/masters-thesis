...
The tableau method is a well known  
...
extending AMR and interpreting it in ways more suitable to
direct inference.  
...
\citet{ogorman-etal-2018-amr} multi-sentence AMR
for document level semantics on top of sentence-level
semantics.
(Maybe better for future work) possibility
document-level and discourse-level inference.

Quantification and scope \citet{pustejovsky-etal-2019-modeling}
...
\citep{bonial-etal-2020-dialogue}
