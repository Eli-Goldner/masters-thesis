...
first-order logic, examples OWL-DL \cite{Pellet} \cite{OWL}.  
...
a knowledge representation \cite{schubert2015}.  
...
translation from AMR to DRT \cite{bos-2020-separating}

AMR expressivity without recurrent variables
(and with no more than one universal quantifier per sentence)
are in the decidable two-variable fragment of first-order logic \cite{bos-2016-squib}

Extension of sentential AMR to incorporate a coarse grained
treatment of tense and aspect \cite{donatelli-etal-2018-annotation}
