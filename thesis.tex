...
\subsubsection{Situation Semantics Influenced -- TTR -- Robin Cooper / Jonathan Ginzburg / Massimio Poesio}
...
\item
  ...
  Notice we've relaxed the requirement that $I_t (c) = I_t' (c)$ for
