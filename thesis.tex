...
In figure \ref{alg2}, \texttt{Apply} is standard continuation based application of predicates \citep{van2010computational}.
...
we are not aware of many efforts in AMR parsing towards accomodating
